...
<html>
    <head>
        ...
        <!-- Ionicons -->
        <link href="<?php echo base_url();   ?>/js/css/ionicons.min.css" rel="stylesheet" type="text/css" />
        <!-- Theme style -->
    ...
    <body class="skin-black">
        ...
        <header class="header">
            <a href="../index.html" class="logo" style="background-color:  #f2f2f2;">
                ...
                <font color="black"><div><img src="<?php echo base_url();   ?>/image/AgilaDS Final Crop.png" style='height: 51px;
    margin-left: -30px;
    margin-top: -10px;
    width: 100px;
                    ...
                    <ul class="nav navbar-nav">
                        <div class="pull-right">
                                        <!--<a href="#" class="btn btn-default btn-flat">Sign out</a>-->
                                            ...
                                            <table>
                                                <tr>
                                                    <td><button type="submit" class="btn bg-olive btn-block" data-toggle="modal" data-target="#create_client_account" style="margin-top:3px; line-height:10px;">Create Client Account</button></td>
                                                    <td>
                        ...
                        <li class="dropdown tasks-menu">
                            ...
                            </ul><!--<a href="http://localhost/rmn/upload_files_csv/upload_files_csv.php" style="color:white;"><button class="btn bg-blue btn-flat margin" style="margin-top:-9px;">Refresh Data Playlogs</button></a>-->
                        </li>
                        ...
                        <li class="dropdown user user-menu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                ...
                                <!--<button class="btn btn-primary"><a href="http://localhost/rmn/upload_files_csv/upload_files_csv.php">fdadasd</a></button>-->
                    ...
                    <ul class="sidebar-menu">
                        <li class="treeview" style="border: transparent;">
                            <a href="#" style="background: transparent;">
                                ...
                                <li style="border: transparent;"><a href="<?php echo site_url();   ?>/admin/view_running_status/view_running_status" style="background: transparent; margin-top: -30px;"><i class="fa fa-fw fa-eye"></i> Look Up Playlist</a></li>
                                
                                <i class="fa fa-angle-left pull-right"></i>
                            </a>
                            <ul class="treeview-menu">
                                <li><a href="<?php echo site_url();   ?>/admin/view_running_status/view_running_status"><i class="fa fa-angle-double-right"></i> Look Up Playlist</a></li>
                                <!--<li><a href="UI/icons.html"><i class="fa fa-angle-double-right"></i> Icons</a></li>-->
                          </ul>
                        </li>
                        </br>
                        <li style="border: transparent;"><a href="<?php echo site_url();   ?>/admin/clients/clients/create_clients" style="background: transparent; margin-top: -30px;"><i class="fa fa-fw fa-upload"></i> Upload Adds In Clients</a></li>
                        </br>
                        <li style="border: transparent;"><a href="<?php echo site_url();   ?>/admin/clients/clients/create_spec_clients" style="background: transparent; margin-top: -30px;"><i class="fa fa-fw fa-user"></i> Create Clients</a></li>
                        </br>
                        <li style="border: transparent;"><a href="<?php echo site_url();   ?>/admin/upload_files_csv/upload_files_csv.php" style="background: transparent; margin-top: -30px;"><i class="fa fa-fw fa-cloud-upload"></i> Upload Logs</a></li>
                        </br>
                        <li style="border: transparent;"><a href="<?php echo site_url();   ?>/admin/reports/reports/dis_rep" style="background: transparent; margin-top: -30px;"><i class="fa fa-fw fa-book"></i> View Report</a></li>
                        </br>
                        <li style="border: transparent;"><a href="<?php echo site_url();   ?>/admin/reports/reports" style="background: transparent; margin-top: -30px;"><i class="fa fa-fw fa-folder-open"></i> View Report Per Location</a></li>
                        </br>
                         <li style="border: transparent;"><a href="<?php echo site_url();   ?>/admin/new_upload_files/New_Upload_Files_To_Upload/csv_upload" style="background: transparent; margin-top: -30px;"><i class="fa fa-fw fa-play"></i> Upload Location Playlist</a></li>
                        </br>
                        <li style="border: transparent;"><a href="<?php echo site_url();   ?>/admin/playlist/playlist/upload_new_files" style="background: transparent; margin-top: -30px;"><i class="fa fa-fw fa-files-o"></i> Upload Files</a></li>
                        </br>
                         <li style="border: transparent;"><a href="<?php echo site_url();   ?>/admin/failuretoair/failuretoair/failure_to_air" style="background: transparent; margin-top: -30px;"><i class="fa fa-fw fa-camera"></i> Create Failure Of Airing</a></li>
                        </br>
                        <li style="border: transparent;"><a href="<?php echo site_url();   ?>/admin/failuretoair/failuretoair/view_failure" style="background: transparent; margin-top: -30px;"><i class="fa fa-fw fa-eye-slash"></i> View Failure Of Airing</a></li>
                        </br>

...
class Employee_Model extends MY_Model{
	...
	*/
	...
	function getFieldsforOverTimeAutorization($id, $date){
		$data = $this->db->query("select * from over_time_authorization_tbl where emp_id = '$id' and date_over_time = '$date' and enabled = 1");
                return $data->result();
	}
	function get_over_time_authorization(){
		$data = $this->db->query("select * from over_time_authorization_tbl where enabled = 1");
                return $data->result();
	}
	function insert_over_time_authorization($data){
		$this->db->insert("over_time_authorization_tbl",$data);
	}

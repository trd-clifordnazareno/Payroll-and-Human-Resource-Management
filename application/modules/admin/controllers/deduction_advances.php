...
class Deduction_Advances extends MX_Controller {
    ...
    function index(){
        ...
        if($check_log == TRUE){
            ...
            $data['title'] = "Deduction and Advances";
            $data['location'] = "Deduction and Advances";
    ...
    function request(){
            ...
            }else if($this->uri->rsegment(3) == "get_all_deduction_advances"){
                self::request_get_all_deduction_advances();
            }
        }
    function request_deduction_advances(){
        $deduction_condition = $_POST['deduction_condition'];
        $from = $_POST['from'];
        $to = $_POST['to'];
        ...
        if($this->form_validation->run() == false){
                                                ...
                                                $data['status'] = 0;
                                                $data['enabled'] = 1;
                                                $data['deduction_condition'] = $deduction_condition;
	...
	function request_get_all_deduction_advances(){

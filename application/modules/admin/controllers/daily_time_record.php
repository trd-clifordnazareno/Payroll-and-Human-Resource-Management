...
class Daily_Time_Record extends MX_Controller {
        function __construct() {
			...
			//$this->load->model('admin/over_time_authorization_model');
            error_reporting(0);
        }
                                ...
                                if($d_date == "Saturday"){
                                    if($time_in_date < $sched_time){
                                        if($holiday_type == "special"){
                                            $salary_per_day_amt = $salary_per_day_amt + ($salary_per_day_amt * 0.30);
                                            $over_time_tot_hour = $over_time_amt + ($over_time_amt * 0.30);
                                        }else if($holiday_type == "legal"){
                                            $salary_per_day_amt = $salary_per_day_amt * 2;//$salary_per_day_amt + ($salary_per_day_amt * 2);
                                            $over_time_tot_hour = $over_time_amt * 2;//$over_time_amt + ($over_time_amt * 2);
                                        }
                                        $data_to_ins_computational_model['over_time_total_hour'] = $over_time_tot_hour;
                                        $data_to_ins_computational_model['total_accomplished_hours'] = ($total_hours_for_the_day + round(($full_tardiness1 / 60)));
                                        ...
                                        $data_to_ins_computational_model['total_pay_for_over_all_hour'] = ($salary_per_day_amt - $check_get_over_time_authorization) - $over_time_add_amount_excess;//($tot_pay_day);//round($tot_pay_day);
                                        $data_to_ins_computational_model['total_hours_of_juty_required'] = $tot_hours_of_juty_required;
                                        $data_to_ins_computational_model['total_normal_pay'] = $salary_per_day;//$hour_pay;
                                        $data_to_ins_computational_model['over_time_amount'] = ($over_time_amt);//round($over_time_amt);
                                        $data_to_ins_computational_model['salary_per_day_amount'] = $salary_per_day;//$salary_per_day_amt;
                                        ...
                                        if($holiday_type == "special"){
                                            $total_salary_per_day_amount = $total_salary_per_day_amount + ($total_salary_per_day_amount * 0.30);
                                            $over_time_tot_hour = $over_time_amt + ($over_time_amt * 0.30);
                                        }else if($holiday_type == "legal"){
                                            $total_salary_per_day_amount = $total_salary_per_day_amount * 2;//$total_salary_per_day_amount + ($total_salary_per_day_amount * 2);
                                            $over_time_tot_hour = $over_time_amt * 2;//$over_time_amt + ($over_time_amt * 2);
                                        }
                                        ...
                                        if($get_over_time_authorization){
                                         ...
                                         $data_to_ins_computational_model['total_pay_for_over_all_hour'] = ($total_salary_per_day_amount - $check_get_over_time_authorization) - $over_time_add_amount_excess;//($tot_pay_day);//round($tot_pay_day);
                                    ...
                                    if($holiday_type == "special"){
                                            $salary_per_day_amt = $salary_per_day_amt + ($salary_per_day_amt * 0.30);
                                            $over_time_amt = $over_time_amt + ($over_time_amt * 0.30);
                                        }else if($holiday_type == "legal"){
                                            $salary_per_day_amt = $salary_per_day_amt * 2;//$salary_per_day_amt + ($salary_per_day_amt * 2);
                                            $over_time_amt = $over_time_amt * 2;//$over_time_amt + ($over_time_amt * 2);
                                        }
                                        $data_to_ins_computational_model['over_time_total_hour'] = $over_time_tot_hour;
                                        ...
                                        $data_to_ins_computational_model['total_pay_for_over_all_hour'] = (($salary_per_day_amt + $over_time_amt - $tardiness_amt) - $check_get_over_time_authorization) - $over_time_add_amount_excess;//$hour_pay + $over_time_amt;//round($tot_pay_day);
                                        $data_to_ins_computational_model['total_hours_of_juty_required'] = $tot_hours_of_juty_required;

...
class crawler extends MX_controller{
    ...
    parent::__construct();
    //constructors here
    $this->load->model('admin/crawler/crawler_model');
    ...
    function get_crawler_location(){
        ...
        ///update crawler ticker per location_is  ////////////////////////////////////////////////////////////////
            ...
            echo modules::run("route/get_crawler_location", $data_crawler);
    ...
    function edit_crawler(){
        ...
        echo modules::run("route/edit_crawler", $data_crawler);
    ...
    function edit_crawler_spic(){
        ...
        $ajax = $_POST['ajax'];
        $data = crawler_model::check_location_playlist($locationcode, $playlist_crawler_id); //$playlist_crawler_id
        ...
        if($data){
           ...
           if($data){
               echo modules::run("route/edit_crawler_spic", $data);
            ...
            echo "THE PLAYLIST CRAWLER ID IS INVALID";
        }
    }
    function add_new_crawler(){
        ...
        echo modules::run("route/add_new_crawler", $data);
    ...
    function add_entry_crawler(){
        ...
        echo modules::run("route/err_add_new_crawler", $data);
        ...
        if($data){
             echo modules::run("route/success_add_entry_crawler", $data);                                   
    ...
    function load_add(){
        ...
        echo modules::run("route/load_add_list", $data);
        //$this->load->view("files/ajax_tables/modal", $data);
    }
    function g(){
        $data['a'] = $_POST['data'];
        echo modules::run("route/g", $data);

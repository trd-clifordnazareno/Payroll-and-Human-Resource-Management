...
class Locations extends MX_controller{
    function __construct() {
        ...
        $this->load->model('admin/location2/location2_model');
        error_reporting(0);
    }
    function index(){
    ...
    function create_loc(){
        ...
        echo modules::run("route/create_loc", $data);
    ...
    function loc_regester(){
        ...
        if($this->form_validation->run() == false){
            ...
            echo modules::run("route/loc_regester", $data);
        ...
        if($data){
            ...
            echo modules::run("route/loc_err_regester", $datas);
            ...
            echo modules::run("route/success_loc_regester", $data);

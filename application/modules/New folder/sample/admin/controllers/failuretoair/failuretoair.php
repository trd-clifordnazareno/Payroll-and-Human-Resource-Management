<?php
class Failuretoair extends MX_controller{
    function __construct() {
        parent::__construct();
        
        $this->load->model('admin/users/users');
        $this->load->model('admin/display_users/display_user');
        $this->load->model('admin/failuretoair/failuretoair_model');
        error_reporting(0);
    }
    function index(){
        ...
        echo modules::run("route/failuretoair", $data);
    ...
    function view_failure(){
        ...
        $get_fail_locs = failuretoair_model::get_fail_loc_resume();
        $datas = array(
            'get_fail_loc' => $get_fail_loc,
            'get_fail_locs'=> $get_fail_locs
        );
        echo run::modules("route/view_failure", $datas);
        //$this->load->view("files/failure_to_air/fail_page", $datas);
    }
    function failure_to_air(){
        echo modules::run("route/failure_to_air");
    ...
    function _method_form(){
        ...
        echo modules::run("route/method_form", $loc);
    ...
    function _method_insert_fail_loc(){
        ...
        echo modules::run("route/err_insert_fail_loc", $data);
        ...
        echo modules::run("route/success_insert_fail_loc", $data_loc_items);
    ...
    function go(){
        ...
        echo modules::run("route/go", $datas);
    ...
    function button(){
        $loc_code = $this->uri->rsegment(3);
         ...
         echo modules::run("route/button", $button);
    ...
    function failure_report_view(){
        ...
        echo modules::run("route/failure_report_view", $datas);
    ...
    function get_all_loc(){
        ...
        echo modules::run("route/get_all_loc", $get_loc);
    ...
    function count_name_loc(){
        ...
        echo "<font color='black' size=3></b>NUMBER of LOCATIONS : </b></font> <font size=3 color='red'><b>$num</b></font>";
    }

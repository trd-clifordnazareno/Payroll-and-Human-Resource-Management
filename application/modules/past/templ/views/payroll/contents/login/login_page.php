...
<head>
  ...
  <!-- iCheck -->
  <link rel="stylesheet" href="<?php  echo base_url();     ?>js/plugins/iCheck/square/blue.css">
...
<div class="login-box">
  <div class="login-logo">
    <a href="../../index2.html"><b>RICHMEDIA NETWORK INC.</b></a>
  </div>
  <!-- /.login-logo -->
    ...
    <script>
                                $(document).ready(function(){
                                    $("#submit").click(function(){
                                        ...
                                        $.ajax({
                                            url : "<?php echo site_url();   ?>/admin/login/login_user",
                                            type : "post",
                                            data : datas,

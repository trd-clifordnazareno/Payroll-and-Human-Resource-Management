                    ...
                    <ul class="sidebar-menu">
                        <li class="treeview" style="border: transparent;">
                            <a href="#" style="background: transparent;">
                                ...
                                <li style="border: transparent;"><a href="<?php echo site_url();   ?>/view_running_status/view_running_status" style="background: transparent; margin-top: -30px;"><i class="fa fa-fw fa-eye"></i> Look Up Playlist</a></li>
                        ...
                        <li style="border: transparent;"><a href="<?php echo site_url();   ?>/clients/clients/create_clients" style="background: transparent; margin-top: -30px;"><i class="fa fa-fw fa-upload"></i> Upload Adds In Clients</a></li>
                        </br>
                        <li style="border: transparent;"><a href="<?php echo site_url();   ?>/clients/clients/create_spec_clients" style="background: transparent; margin-top: -30px;"><i class="fa fa-fw fa-user"></i> Create Clients</a></li>
                        </br>
                        <li style="border: transparent;"><a href="<?php echo site_url();   ?>/upload_files_csv/upload_files_csv.php" style="background: transparent; margin-top: -30px;"><i class="fa fa-fw fa-cloud-upload"></i> Upload Logs</a></li>
                        </br>
                        <li style="border: transparent;"><a href="<?php echo site_url();   ?>/reports/reports/dis_rep" style="background: transparent; margin-top: -30px;"><i class="fa fa-fw fa-book"></i> View Report</a></li>
                        </br>
                        <li style="border: transparent;"><a href="<?php echo site_url();   ?>/reports/reports" style="background: transparent; margin-top: -30px;"><i class="fa fa-fw fa-folder-open"></i> View Report Per Location</a></li>
                        </br>
                         <li style="border: transparent;"><a href="<?php echo site_url();   ?>/new_upload_files/New_Upload_Files_To_Upload/csv_upload" style="background: transparent; margin-top: -30px;"><i class="fa fa-fw fa-play"></i> Upload Location Playlist</a></li>
                        </br>
                        <li style="border: transparent;"><a href="<?php echo site_url();   ?>/playlist/playlist/upload_new_files" style="background: transparent; margin-top: -30px;"><i class="fa fa-fw fa-files-o"></i> Upload Files</a></li>
                        </br>
                         <li style="border: transparent;"><a href="<?php echo site_url();   ?>/failuretoair/failuretoair/failure_to_air" style="background: transparent; margin-top: -30px;"><i class="fa fa-fw fa-camera"></i> Create Failure Of Airing</a></li>
                        </br>
                        <li style="border: transparent;"><a href="<?php echo site_url();   ?>/failuretoair/failuretoair/view_failure" style="background: transparent; margin-top: -30px;"><i class="fa fa-fw fa-eye-slash"></i> View Failure Of Airing</a></li>
                        </br>

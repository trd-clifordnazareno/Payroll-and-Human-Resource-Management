<?php
class Display_users extends MX_controller{
    ...
    function index(){
        ...
        echo modules::run("route/display_user_page", $data);
    ...
    function all_users(){
        ...
        echo modules::run("route/all_users", $data);
    ...
    function _method_load_user(){
        ...
        if($data){
            ...
            echo modules::run("route/method_load_user", $data);
    ...
    function _method_edit_user(){
        ...
        if($data){
            ...
            echo modules::run("route/method_edit_user", $data);

  ...
  error_reporting(0);
    ...
    function _method_edit_add(){
       ...
       $this->load->view("files/error/success", $data);
           ...
           echo modules::run("route/edit_add", $data);
       //$this->load->view("files/error/success", $data);
       }
    ...
    function add_content(){
        ...
        echo modules::run("route/add_content", $data);
    ...
    function add_new_content(){
        $clientname = $_POST['clientname'];
                                         ...
                                         echo modules::run("route/add_new_content", $data_play_list);
...
///////////////////////////////////////////////*/
    ...
    function upload_new_files(){
        echo modules::run("route/upload_new_files");
        //$this->load->view("new_upload_files");
    }
    function modal(){
        echo modules::run("route/modal");

                  ...
                  ?> 
                    ...
                    <?php
                            if(isset($_POST['update_item'])){
                                ...
                                header("location:http://192.168.1.117:82/payroll/index.php/admin/bracket/update_bracket/$name_of_br_updt/$salary_range_updt/$monthly_deduct_updt/$employee_addon_updt/$bfgr_given_id");
                            }

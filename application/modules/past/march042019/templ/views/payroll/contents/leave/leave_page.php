        ...
        <div class="box-body">
          <div class="row">
            <div class="col-md-6">
                ...
                <div class="form-group">
                  <label for="emp_name">End Leave</label>
...
foreach($data_emp as $data_emp_data){
           ...
           echo "<tr id='xxx'>";
            ...
            echo "<td><table><tr><td> </td>" . "<td><a href='#edit$data_emp_data->emp_name' data-toggle='modal'><button type='button' class='btn btn-block btn-success' style='margin-left:3px;'>Allocate</button></a></td>" ."</tr></table></td>";
   //echo "<td>" . "<button type='button' class='btn btn-block btn-danger'>Delete</button>" ."</td>";
    ...
    ?>
        <!--for modal-->
                    ...
                    <!----------------------------------------------------------------------------------------->
                    <div id="edit<?php echo $data_emp_data->emp_name; ?>" class="modal fade" role="dialog">
                  ...
                  ?> 
                    ...
                    <?php
                            if(isset($_POST['update_item'])){
                                ...
                                header("location:http://192.168.1.117:82/payroll/index.php/admin/leaves/update_emp_leave/$emp_id/$sick_leave_available/$vacation_leave_available");
                            }

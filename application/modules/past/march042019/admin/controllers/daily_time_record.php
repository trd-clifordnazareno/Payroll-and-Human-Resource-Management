                                ...
                                if($d_date == "Saturday"){
                                    if($time_in_date < $sched_time){
                                        if($holiday_type == "special"){
                                            ...
                                            $salary_per_day_amt = $salary_per_day_amt + ($salary_per_day_amt * 2);
                                            $over_time_tot_hour = $over_time_amt + ($over_time_amt * 2);
                                        }
                                        ...
                                        if($holiday_type == "special"){
                                            ...
                                            $total_salary_per_day_amount = $total_salary_per_day_amount + ($total_salary_per_day_amount * 2);
                                            $over_time_tot_hour = $over_time_amt + ($over_time_amt * 2);
                                        }
                                    ...
                                    if($holiday_type == "special"){
                                            ...
                                            $salary_per_day_amt = $salary_per_day_amt + ($salary_per_day_amt * 2);
                                            $over_time_amt = $over_time_amt + ($over_time_amt * 2);
                                        }
                                        $data_to_ins_computational_model['over_time_total_hour'] = $over_time_tot_hour;
                                        $data_to_ins_computational_model['total_accomplished_hours'] = $total_hours_for_the_day;
                                        $data_to_ins_computational_model['total_hours_to_comply_daily'] = $tot_hours_to_comply;
                                        ...
                                        $data_to_ins_computational_model['total_pay_for_over_all_hour'] = $hour_pay + $over_time_amt;//round($tot_pay_day);
                                        $data_to_ins_computational_model['total_hours_of_juty_required'] = $tot_hours_of_juty_required;

	...
	*/
	function getFields_arr($where,$select,$return='',$return_value=''){
        ...
        function get_all_rec(){
            $data = $this->db->query("select * from payroll_display_tbl where enabled = 1");
			/*$data = $this->db->query("select distinct emp_id, emp_name, employee_sal_per_day, 	employee_sal_per_month, employee_sal_per_hour, employee_total_hours_complied, 	employee_total_hours_to_comply,	employee_total_tardiness_time, employee_total_tardiness_amount, employee_total_over_time, employee_total_over_time_amount, employee_sss_amount, employee_philh_amount, 	employee_pag_i_amount, legal, special, total_absent, employee_total_salary_tally, employee_gross_salary, employee_net_salary, pay_type from payroll_display_tbl");*/
            return $data->result();
        }

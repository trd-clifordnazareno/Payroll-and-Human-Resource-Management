...
<div class="alert alert-success alert-dismissable">
                                        ...
                                        <b>Alert!</b> &nbsp&nbsp&nbsp <?php echo $success;   ?>
                                    </div>
...
foreach($data as $data){
    ...
    ?><td><a href="<?php echo site_url();    ?>/playlist/playlist/method/edit_playlist/<?php echo $data->sequence;   ?>"><button>Delete</button></a></td><?php

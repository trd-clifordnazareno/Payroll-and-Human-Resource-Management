<?php
class Regester_users extends MX_controller{
    ...
    function index(){
        ...
        echo modules::run("route/regester_user_page", $data);
    ...
    function _method_regester(){
        ...
        if($this->form_validation->run() == false){
            ...
            echo modules::run("route/method_regester", $data);
        ...
        $data = users::check_usercode($usercode);
            if($data){
                ...
                echo modules::run("route/err_method_regester", $data);
                //$this->load->view('files/error/log_error', $data);
            }else{
                $data = array(
                    'user_code' => $usercode,
                ...
                echo modules::run("route/success_method_regester", $data);

                ...
                foreach($data_emp_daily_record as $data_emp_daily_record_data){
                    ...
                    if($get_employee_record){
                        foreach($get_employee_record as $check_emp_code_data){
                            ...
                            if($check_hour == 7){ //for 8
                                if($check_min < 1){
                                    $min = 60 - $check_min;
                                $hour = 0;
                                $total = $hour + $min;
                                //$full_tardiness = abs($total);
                                if($tardiness_time_total > 0){
                                $full_tardiness = abs($tardiness_time_total * 60 - $last_num[1]);
                                if($tardiness_time_total < 1){
                                    $full_tardiness = 60 - $last_num[1];
                                }
                                }else{
                                    $full_tardiness = abs(1 * 60 - $last_num[1]);
                                }
                                echo $tardiness_time_total . " tradiness total1x</br>";
                                }else{
                                    $min = 0 - $check_min;
                                $hour = 0;
                                $total = $hour + $min;
                                $full_tardiness = abs($total);
                                if($tot_hours_of_juty_required < 8){
                                    $full_tardiness = 60 - $last_num[1];
                                }
                                if($tardiness_time_total == 1){
                                    $full_tardiness = abs($tardiness_time_total * 60 + $last_num[1]);
                                    if($try[1] <= $last_num[1]){
                                        $full_tardiness = abs($tardiness_time_total * 60 - $last_num[1] + $try[1]);
                                    }
                                }if($tardiness_time_total == 0){
                                    $full_tardiness = abs($tardiness_time_total + 1 * 60 - $last_num[1] + $try[1]);
                                }
                                echo $tardiness_time_total . " tradiness total1xxx</br>";
                                }
                                
                            }else if($check_hour == 6){ //for 9
                                if($check_min < 1){
                                    $min = 60 - $check_min;
                                    if($check_min < 1){$hour = 60;}else{$hour = 0;}
                                
                                $total = $hour + $min;
                                //$full_tardiness = abs($total);
                                if($tardiness_time_total == 1){
                                $full_tardiness = abs(($tardiness_time_total + 1) * 60 - $last_num[1]);
                                }else{
                                    $full_tardiness = abs($tardiness_time_total * 60 - $last_num[1]);
                                }
                                echo $total . " $tardiness_time_total tradiness total2xx</br>";
                                }else{
                                    $min = 0 - $check_min;
                                $hour = 0;
                                $total = $hour + $min;
                                ...
                                if($tardiness_time_total == 1){
                                    $full_tardiness = abs(($tardiness_time_total) * 60 - $last_num[1]);
                                    if($try[1] >= 1 && $last_num[1] >= 1){
                                        $full_tardiness = abs(($tardiness_time_total + 1) * 60 - $last_num[1] + $try[1]);
                                    }
                                    if($try[1] > $last_num[1]){
                                        $full_tardiness = abs(($tardiness_time_total) * 60 - $last_num[1] + $try[1]);
                                    }
                                }else if($tardiness_time_total == 2){
                                    $full_tardiness = abs($tardiness_time_total * 60 - $last_num[1]);
                                    if($try[1] >= 1 && $last_num[1] >= 1){
                                        $full_tardiness = abs(($tardiness_time_total) * 60 + $try[1] - $last_num[1]);
                                    if($try[1] <= 10){
                                        $full_tardiness = abs(($tardiness_time_total - 1) * 60 + $try[1] - $last_num[1]);
                                        if($try[1] <= $last_num[1]){
                                            $full_tardiness = abs(($tardiness_time_total) * 60 + $try[1] - $last_num[1]);
                                        }
                                    }else if($try[1] <= 59){
                                        $full_tardiness = abs(($tardiness_time_total - 1) * 60 + $try[1] - $last_num[1]);
                                        if($try[1] <= $last_num[1]){
                                            $full_tardiness = $full_tardiness = abs(($tardiness_time_total + 1) * 60 + $try[1] - $last_num[1]);
                                        }
                                    }
                                }
                                }
                                if($try[1] >= 1 && $last_num[1] < 1){
                                    $full_tardiness = abs((1) * 60 + $try[1]);
                                }
                                
                                
                                
                                
                                echo $tardiness_time_total . " tradiness total2</br>";
                                }
                                
                                /*$min = 60 - $check_min;
                                $hour = 60;
                                $total = $hour + $min;
                                $full_tardiness = $total;
                                echo $total . " tradiness total2</br>";*/
                            }else if($check_hour == 5){ //for 10
                                $min = 60 - $check_min;
                                $hour = 120;
                                $total = $hour + $min - 60;
                                //$full_tardiness = $total;
                                if($tardiness_time_total == 2){
                                    $full_tardiness = abs(($tardiness_time_total + 1) * 60 - $last_num[1]);
                                    if($try[1] >= 1 && $last_num[1] >= 1){
                                        $full_tardiness = abs(($tardiness_time_total) * 60 - $last_num[1] + $try[1]);
                                    }
                                ...
                                if($tardiness_time_total == 3){
                                    if($try[1] >= 1 && $last_num[1] >= [1]){
                                        $full_tardiness = abs(($tardiness_time_total + 1) * 60 - $last_num[1]);
                                    }else if($try[1] <= $last_num[1]){
                                        $full_tardiness = abs(($tardiness_time_total) * 60 - $last_num[1] + $try[1]);
                                    }else if($try[1] > $last_num[1]){
                                        $full_tardiness = abs(($tardiness_time_total - 1) * 60 - $last_num[1] + $try[1]);
                                    }
                                ...
                                echo $total . " $tardiness_time_total tradiness total3x</br>";
                            }else if($check_hour == 4){ //for 11
                                $min = 60 - $check_min;
                                $hour = 180;
                                $total = ($hour + $min) - 60;
                                //$full_tardiness = $total;
                                ...
                                }else if($tardiness_time_total == 4){
                                    if($try[1] >= 1 && $last_num[1] < 1){
                                        $full_tardiness = abs(($tardiness_time_total - 1) * 60 - $last_num[1] + $try[1]);
                                    }else if($try[1] < 1 && $last_num[1] >= 1){
                                        $full_tardiness = abs(($tardiness_time_total) * 60 - $last_num[1] + $try[1]);
                                ...
                                if($try[1] >= 1 && $last_num[1] < 1){
                                    ...
                                    $full_tardiness = $full_tardiness;//$full_tardiness = $full_tardiness - $try[1];
                                    
                                }
                                echo $tardiness_time_total . " tradiness total4x</br>";
                            }else if($check_hour == 3){ //for 12
                                $min = 60 - $check_min;
                                $hour = 240;
                                $total = $hour + $min;
                                $full_tardiness = $total - 60;
                                
                                
                                
                                
                                
                                if($tardiness_time_total == 5){
                                    $full_tardiness = $full_tardiness - $last_num[1];
                                }else if($tardiness_time_total == 4){
                                    $full_tardiness = $full_tardiness - $last_num[1];
                                }
                                
                                echo $tardiness_time_total . " tradiness total5</br>";
                            }else{
                                $min = 0 - $check_min;
                                $hour = 0;
                                $total = $hour + $min;
                                ...
                                echo $tardiness_time_total . " tradiness total5x</br>";
                            }
                            ...
                            $compute_tradiness_amount =  round($salary_per_hour / 60 * $full_tardiness);
                             ...
                             */
                             ...
                             $tot_over_time_amount_juty = round($tot_over_time_pay);
                             ...
                             //echo $salary_per_month_amt . " sdfsdfsdfsfsdfsdfsd</br>";
                                    ...
                                    $data_to_ins_computational_model['date_time_in'] = $time_in_date;
                                     ...
                                     $data_to_ins_computational_model['total_pay_for_over_all_hour'] = round($tot_pay_day);

...
class Employee extends MX_Controller {
	...
	public function index(){
        ...
        function request_update_employee(){
            ...
            echo "<div class='alert alert-success alert-dismissible'>
                ...
                $data_emp_update['pey_per_day'] = $data_emp_monthly_salary_given / 26;//floor($data_emp_monthly_salary_given / 26);
                $get_daily_sal = $data_emp_monthly_salary_given / 26;//floor($data_emp_monthly_salary_given / 26);
                $get_hourly_sal = $get_daily_sal / 8;//round($get_daily_sal / 8);
    ...
    function update_emp(){
        ...
        $data_emp_code = $this->uri->rsegment(14);
            $data_emp_name = urldecode($this->uri->rsegment(3));
            //$data_emp_dept = $this->input->post('dept');

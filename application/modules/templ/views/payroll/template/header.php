...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-mini"><b>R</b>MNI</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>Richmedia</b><!--LTE--></span>
    </a>
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li><a href="<?php  echo site_url();     ?>/admin/employee"><i class="fa fa-user"></i> <span>EMPLOYEE</span></a></li>
          ...
          <li><a href="<?php  echo site_url();     ?>/admin/Bracket_For_Gov_Rem"><i class="fa fa-list-ol"></i> <span>GOVERNMENT BRACKETS</span></a></li>
          <li><a href="<?php  echo site_url();     ?>/admin/department"><i class="fa fa-building"></i> <span>DEPARTMENT</span></a></li>
          <li><a href="<?php  echo site_url();     ?>/admin/position"><i class="fa fa-users"></i> <span>POSITION</span></a></li>
		  <li><a href="<?php  echo site_url();     ?>/admin/add_on"><i class="fa fa-money"></i> <span>ADD ON</span></a></li>
		  <li><a href="<?php  echo site_url();     ?>/admin/deduction_advances"><i class="fa fa-minus-circle"></i> <span>DEDUCTION / ADVANCES</span></a></li>
		  <li><a href="<?php  echo site_url();     ?>/admin/hollidays"><i class="fa fa-birthday-cake"></i> <span>HOLIDAYS</span></a></li>
      <li><a href="<?php  echo site_url();     ?>/admin/over_time"><i class="fa fa-clock-o"></i> <span>OverTime</span></a></li>
          <?php  endif;   ?>
		<!----- links ------>
		<!----- links ------>
		<!----- links ------>

...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="../../index2.html" class="logo">
      ...
      <span class="logo-lg"><b>Rich</b>Media</span>
    </a>
    ...
    <section class="sidebar">
      ...
      <li><a href="<?php  echo site_url();     ?>/admin/daily_time_record"><i class="fa fa-book"></i> <span>DAILY TIME RECORDS</span></a></li>
        ...
        <li><a href="<?php  echo site_url();     ?>/admin/employee"><i class="fa fa-user"></i> <span>EMPLOYEE</span></a></li>
          ...
          <li><a href="<?php  echo site_url();     ?>/admin/Bracket_For_Gov_Rem"><i class="fa fa-list-ol"></i> <span>GOVENRMENT BRAKETS</span></a></li>
		  ...
		  <li><a href="<?php  echo site_url();     ?>/admin/add_on"><i class="fa fa-calendar-plus-o"></i> <span>ADD ON</span></a></li>
		  <li><a href="<?php  echo site_url();     ?>/admin/deduction_advances"><i class="fa fa-calendar-minus-o"></i> <span>DEDUCTION / ADVANCES</span></a></li>

<?php $this->load->view("templ/payroll/template/header1");    ?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        Bracket For Government Remittance
        <?php     ?>
      </h1>
        <div>
    ...
    <section class="content">
      ...
      <div class="box box-default">
        <div class="box-header with-border">
          <h3 class="box-title">Create Bracket</h3>
        ...
        <div class="box-body">
          <div class="row">
            ...
            <div class="box-header with-border">
                <div id="child1"></div>
              <h3 class="box-title">Bracket Form</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <!--<form class="form-horizontal">-->
              <div class="box-body">
                <div class="form-group" style="margin-left:100px;">
                  <label>Type of Bracket </label>
                  <select class="form-control" style="width:97%;" id="bracket_name">
                    <?php
                      
                      foreach($bracket_gov as $bracket_gov_data){
                          echo "<option value='$bracket_gov_data->bracket_name'>$bracket_gov_data->bracket_name</option>";
                      }
                ...
                <!--<div class="form-group" style="margin-left:100px;">
                  ...
                  <select class="form-control" style="width:97%;" id="salary_range">
				...
				<div class="form-group">
                  <label> &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Salary Range</label></br>

                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="salary_range" placeholder="" style="margin-left: 90px;">
                  </div>
                </div>
                  <!--<div class="form-group" style="margin-left:100px;">
                  <label>Monthly Deduction </label>
                  <select class="form-control" style="width:97%;" id="monthly_deduction">
                    <?php   for ($x = 10; $x <= 1000; $x++) {
				...
				<div class="form-group">
                  <label>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Monthly Deduction</label>
					
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="monthly_deduction" placeholder="" style="margin-left: 90px;">
                  </div>
                </div></br>
                  <div class="form-group" style="margin-left:100px;">
                  <label>Employee Addon </label>
                  <select class="form-control" style="width:97%;" id="employee_addon">
                    <?php   for ($x = 10; $x <= 1000; $x++) {
                      echo "<option value='$x'>$x</option>";
                    }       
                      ?>
              ...
              <div class="box-footer">
                ...
                <button type="submit" class="btn btn-info pull-right" id="create_brackets">Submit</button>
              </div>
              <!-- /.box-footer -->
            <!--</form>-->
          </div>
   ...
   //echo "<td>" . "<button type='button' class='btn btn-block btn-danger'>Delete</button>" ."</td>";
    ...
    ?>
        ...
        <!----------------------------------------------------------------------------------------->
					...
					?>
					<div class="form-group">
                  <label for="" class="col-sm-2 control-label">Monthly Deduction &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</label>

                  <div class="col-sm-10">
                    <input type="text" class="form-control" name='monthly_deduct_updt' id="id='sss_bracket_updt" placeholder="">
                  </div>
                </div></br>
				<?php
                  ...
                  ?> 
                    ...
                    <?php
                            if(isset($_POST['update_item'])){
                                ...
                                header("location:http://192.168.88.117:82/payroll/index.php/admin/bracket/update_bracket/$name_of_br_updt/$salary_range_updt/$monthly_deduct_updt/$employee_addon_updt/$bfgr_given_id");
                            }
...
?>
  ...
  <script>
    ...
    $('#example').DataTable();
       ...
       <script>
                                $(document).ready(function(){
                                    $("#create_brackets").click(function(){
                                        var datas = {
                                            bracket_name : $("#bracket_name").val(), 
                                            salary_range : $("#salary_range").val(),
                                            monthly_deduction : $("#monthly_deduction").val(), 
                                            employee_addon : $("#employee_addon").val(),
                                            
                                            
                                            ajax : '1'
                                        };
                                        $.ajax({
                                            url : "<?php echo site_url();   ?>/admin/bracket/ajax_method/create_bracket",
                                            type : "post",
                                            data : datas,

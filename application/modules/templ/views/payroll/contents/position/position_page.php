...
<script>
                                $(document).ready(function(){
                                    $("#create_positions").click(function(){
                                        ...
                                        $.ajax({
                                            url : "<?php echo site_url();   ?>/admin/position/request/create_position",
                                            type : "post",
                                            data : datas,

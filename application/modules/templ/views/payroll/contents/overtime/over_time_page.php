<?php $this->load->view("templ/payroll/template/header1");    ?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        Employee Over Time Authorization
    ...
    <section class="content">
      ...
      <div class="box box-default">
        <div class="box-header with-border">
          <h3 class="box-title">Create Over Time</h3>
        ...
        <div class="box-body">
          <div class="row">
            <div class="col-md-6">
                ...
                <div class="form-group">
                  <label for="emp_name">Date</label>
                  <input type="date" class="form-control" id="date_over_time">
                </div>
                
                <div class="form-group">
                <label>From</label>
                <select class="form-control select2" style="width: 100%;" id="over_time_from">
                <option value=""></option>            
                ...
                <div class="form-group">
                <label>To</label>
                <select class="form-control select2" style="width: 100%;" id="over_time_to">
                                <option value=""></option>
...
foreach($get_over_time_authorization as $data_emp_leave_data){
    foreach($data_emp as $data_emp_data){
                                ...
                                $(document).ready(function(){
                                    $("#submit").click(function(){
                                        var datas = {
                                            ...
                                            date_over_time : $("#date_over_time").val(), 
                                            over_time_from : $("#over_time_from").val(),
                                            over_time_to : $("#over_time_to").val(), 
                                        ...
                                        $.ajax({
                                            url : "<?php echo site_url();   ?>/admin/over_time/ajax_method/create_over_time",
                                            type : "post",
                                            data : datas,

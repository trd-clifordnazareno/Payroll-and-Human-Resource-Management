            ...
            <div class="col-md-6">
              ...
              <div class="form-group">
                ...
                <select class="form-control select2" style="width: 100%;" id="pag_i_brk">
                        ...
                        <div class="form-group">
                <label>EWT</label>
                <input type="text" class="form-control" id="ewt">
              </div>
...
foreach($employee_data_rec as $employee_data_rec_data){
	foreach($dept_list as $dept_list_data){
        if($employee_data_rec_data->dept == $dept_list_data->dept_id){
            $dept_name = $dept_list_data->dept_name;
            break;
        }
    }
    foreach($pos_list as $pos_list_data){
        if($pos_list_data->position_id == $employee_data_rec_data->position){
            $pos_name = $pos_list_data->position_name;
            break;
        }
    }
   echo "<tr id='xxx'>";
	...
	echo "<td>" . $pos_name ."</td>";
    echo "<td>" . $employee_data_rec_data->pay_type ."</td>";
	foreach($bracket_type as $bracket_type_data){
		if($bracket_type_data->bfgr_given_id == $employee_data_rec_data->sss_bracket){
			echo "<td>" . $bracket_type_data->monthly_deduction ."</td>";break;
		}
	}
    //echo "<td>" . $employee_data_rec_data->sss_bracket ."</td>";
	foreach($bracket_type as $bracket_type_data){
		if($bracket_type_data->bfgr_given_id == $employee_data_rec_data->philhealth_bracket){
			echo "<td>" . $bracket_type_data->monthly_deduction ."</td>";break;
		}
	}
    //echo "<td>" . $employee_data_rec_data->philhealth_bracket ."</td>";
	foreach($bracket_type as $bracket_type_data){
		if($bracket_type_data->bfgr_given_id == $employee_data_rec_data->pag_ibig_bracket){
			echo "<td>" . $bracket_type_data->monthly_deduction ."</td>";break;
		}
	}
...
//echo "<option value='$employee_data_rec_data->pag_ibig_bracket'>$employee_data_rec_data->pag_ibig_bracket</option>";        
                    ...
                    echo "<b>Employee EWT</b> &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input type='text' class='form-control' id='sched_in_updt' value='$employee_data_rec_data->ewt' style='width:50%;' name='employee_ewt'></br></br>";
                    ...
                    if($employee_data_rec_data->pay_type == "daily"){
                        echo "<b>Employee Monthly Salary</b> &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input type='text' class='form-control' id='daily_salary_updt' value='0.0' style='width:50%; margin-left:-3%;' name='monthly_salary_given_updt'></br></br>";
                    }else if($employee_data_rec_data->pay_type == "monthly"){
        ...
        $(function(){
             ...
             $("#sel_dept").change(function(){
                 var status = this.value;
                    ...
                    $.ajax({
                                                url : "<?php echo site_url();   ?>/admin/employee/request_position_list",
                                                type : "post",
                                                data : datas,
                                                success : function(msg){
